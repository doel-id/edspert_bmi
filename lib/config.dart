...
const primaryColor = Color(0xff1F375D);
const secondaryColor = Color(0xff0D4C8A);

const enableColor = Color(0xffffffff);
const disableColor = Color(0xff99D5E0);
const selectColor = Color(0xffF25330);
...
const String testGitHub2 = "Test Git Hub 2";
